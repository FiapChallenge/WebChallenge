            ...
            <div class="footer-container">
                <div class="upper">
                    <div class="logo-footer">
                        <a href="#"><img class="grayscale" width="184" src={GuincheiLogo} alt="Logo do Guinchei" /></a>
                    </div>
                ...
                <div class="middle">
                    <hr />
                    <a target="-blank" href="https://github.com/Asteriuz/FiapChallenge"><img class="grayscale"
                    ...
                    <a target="-blank" href="https://www.youtube.com/channel/UCTAMms64mj1OIKF6FRvfEsA"><img id="youtube"
                        class="grayscale" src={YoutubeLogo} alt="logo do youtube" /></a>
                </div>
            </div>
            <div class="bottom">
